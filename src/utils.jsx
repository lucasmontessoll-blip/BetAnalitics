...
// ============================================================================
// ️ FUNCOES AUXILIARES OTIMIZADAS
// ============================================================================
...
export const getWeekDays = (b) => Array.from({length: 7}, (_, i) => { const d = new Date(b + "T12:00:00Z"); d.setDate(d.getDate() + i - 3); return { iso: d.toISOString().split('T')[0], nome: ['DOM','SEG','TER','QUA','QUI','SEX','SAB'][d.getDay()], dia: `${String(d.getDate()).padStart(2, '0')}/${String(d.getMonth()+1).padStart(2, '0')}` }; });
...
//  FORMATADOR DE CLASSIFICACAO (Processa o seu arquivo de 2800 linhas)
...
export const listaEsportesFino = [
    ...
    { name: 'Tenis', icon: '' }, { name: 'Futebol Am.', icon: '' },
    { name: 'Beisebol', icon: '' }, { name: 'Voleibol', icon: '' },
    { name: 'Hoquei Gelo', icon: '' }, { name: 'Rugby', icon: '' },
    { name: 'E-Sports', icon: '' }, { name: 'UFC / MMA', icon: '' },
    { name: 'Formula 1', icon: '️' }, { name: 'Golfe', icon: '' },
    { name: 'Futsal', icon: '' }, { name: 'Andebol', icon: '' },
    { name: 'Tenis de Mesa', icon: '' }, { name: 'Snooker', icon: '' },
    { name: 'Dardos', icon: '' }, { name: 'Criquete', icon: '' },
    { name: 'Ciclismo', icon: '' }, { name: 'Badminton', icon: '' },
    { name: 'Polo Aquatico', icon: '' }, { name: 'MotoGP', icon: '️' }
];
...
export const listaLigas = [
    { name: 'Todos', icon: '' },
    { name: 'Brasileirao Serie A', icon: '' }, { name: 'Brasileirao Serie B', icon: '' }, 
    { name: 'Brasileirao Serie C', icon: '' }, { name: 'Copa do Brasil', icon: '' }, 
...
export const MOCK_GAMES = [...JOGOS_MANUAIS, ...RAW_API_RESPONSE.map(f => {
    ...
    return {
        ...
        result_info: f.result_info, predictions: [], odds_format: { home: "-", draw: "-", away: "-" }, venue: f.venue?.name || "Estadio",
