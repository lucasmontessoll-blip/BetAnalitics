        ...
        <div className="flex items-center gap-3 min-w-0">
          {!estaNaTelaInicial && (
            <button
              ...
              className="w-10 h-10 rounded-2xl bg-white/8 border border-white/15 flex items-center justify-center text-white text-3xl font-black shadow-lg active:scale-95 shrink-0"
          ...
          <div className="flex flex-col items-start justify-center min-w-0">
            <img
              ...
              className-white/8 border border-white/15 flex items-center justify-center text-white text-3xl font-black shadow-lg active:scale-95 shrink-0"
              data-bet-retorno-header="true"
              aria-label="Retornar ao início"
            >
              ‹
