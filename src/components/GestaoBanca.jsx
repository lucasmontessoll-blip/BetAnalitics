  ...
  return (
    <>
      <div className="bg-[#0f172a] p-4 sm:p-5 rounded-3xl mb-6 shadow-lg border border-white/5 w-full transform-gpu">
          <h3 className="text-sm font-black text-white mb-4 uppercase tracking-wider flex items-center gap-2"><Activity className="w-4 h-4 text-orange-500"/> Gestao de Risco Diario</h3>
      ...
      <h3 className="text-sm font-black text-white mb-4 uppercase tracking-wider flex items-center gap-2 relative z-10"><Activity className="w-4 h-4 text-red-500"/> Gestao Profissional</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 w-full">
          <div className="bg-[#111827] p-4 sm:p-5 rounded-2xl border border-red-500/20 shadow-lg flex flex-col justify-center transform-gpu min-w-0">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1 flex items-center gap-1 truncate"><TrendingDown className="w-3 h-3 text-red-400 flex-shrink-0"/> Drawdown Max</div>
          ...
          <button onClick={handleRunBacktest} className="bg-gradient-to-br from-blue-700 to-blue-500 p-4 sm:p-5 rounded-2xl border border-blue-400/30 shadow-lg flex flex-col items-center justify-center active:scale-95 transition-transform transform-gpu min-w-0">
              ...
              <div className="text-[10px] text-white font-black uppercase tracking-widest text-center truncate w-full">Rodar Backtest Historico</div>
          </button>
      </div>
    </>
  );
