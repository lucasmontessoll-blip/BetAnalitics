...
export default function EstatisticasAvancadas({ apostas, isPro, onUnlockPro }) {
  ...
  const heatmapSemanal = () => {
    ...
    apostas.forEach(a => {
      const diaStr = a.data; 
      // Ajuste de fuso horario para garantir o dia correto
    ...
    return (
      <div className="bg-[#0f172a] rounded-3xl p-8 mb-6 border border-yellow-500/20 shadow-lg relative overflow-hidden flex flex-col items-center justify-center text-center">
        <div className="absolute inset-0 bg-[#050816]/80 backdrop-blur-md z-10 flex flex-col items-center justify-center p-6">
            ...
            <h3 className="font-black text-white text-lg mb-2">Estatisticas Avancadas PRO</h3>
            <p className="text-xs text-slate-300 mb-6">Desbloqueie o Calendario de Performance, Heatmap, Graficos Mensais e Relatorios em PDF.</p>
        ...
        {/* Fundo simulado desfocado para agucar a curiosidade */}
  ...
  return (
    <div className="flex flex-col gap-6 mb-6">
        ...
        <div className="bg-[#0f172a] p-5 rounded-3xl border border-white/5 shadow-lg">
            <h2 className="text-sm font-black text-white mb-4 uppercase tracking-wider flex items-center gap-2"><Calendar className="w-4 h-4 text-blue-400"/> Calendario de Lucro</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            {/* MESES */}
            <div className="bg-[#0f172a] p-5 rounded-3xl border border-white/5 shadow-lg">
                <h2 className="text-sm font-black text-white mb-4 uppercase tracking-wider flex items-center gap-2"><BarChart3 className="w-4 h-4 text-purple-400"/> Comparacao Mensal</h2>
        ...
        <button onClick={gerarPDF} className="w-full bg-red-600 hover:bg-red-500 transition-colors text-white font-black py-4 rounded-2xl shadow-[0_0_15px_rgba(220,38,38,0.3)] text-xs uppercase tracking-widest flex items-center justify-center gap-2">
            <Download className="w-5 h-5"/> Baixar Relatorio Completo (PDF)
        </button>
