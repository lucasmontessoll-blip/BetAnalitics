...
const fatores=[
  ...
  {titulo:'Forca ofensiva',texto:'Considera volume ofensivo, gols, finalizacoes e pressao de ataque.',icon:Target,cor:'text-blue-400'},
  {titulo:'Forca defensiva',texto:'Avalia vulnerabilidade defensiva, gols sofridos e comportamento em momentos criticos.',icon:ShieldCheck,cor:'text-purple-400'},
  {titulo:'Mercado e odds',texto:'Compara probabilidade estimada com odds disponiveis para identificar distorcoes.',icon:BarChart3,cor:'text-yellow-400'},
  {titulo:'Risco',texto:'Classifica cada analise como risco baixo, medio ou alto. Nem todo jogo e oportunidade.',icon:AlertTriangle,cor:'text-red-400'}
];
  ...
  return(
    <div className="px-4 animate-fade-in pb-24">
      <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-3xl p-6 mb-5 relative overflow-hidden">
        ...
        <p className="text-sm text-blue-100 font-bold mt-2 relative z-10">Entenda os criterios usados pelo Golnexa PRO para gerar analises esportivas.</p>
      </div>
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-3xl p-5 mt-5">
        ...
        <p className="text-[11px] text-yellow-100/80 leading-relaxed">
          As analises sao estimativas estatisticas e educativas. Elas nao garantem resultado, lucro ou acerto.
        </p>
      </div>
    </div>
  );
