...
function oddsPre(h, a, ho, d, ao) { return [{ bookmakers:[{ name:'Golnexa Demo', bets:[{ name:'Match Winner', values:[{value:'Home',odd:String(ho)},{value:'Draw',odd:String(d)},{value:'Away',odd:String(ao)}] },{ name:'Goals Over/Under', values:[{value:'Over 2.5',odd:'1.90'},{value:'Under 2.5',odd:'1.88'}] }] }] }]; }
