...
export default function App() {
  ...
  return (
    <div className="app-layout">
                  ...
                  <>
                      ...
                      <div className="stats-grid">
                        <div className="stat-card">
                          <div className="stat-number">{jogos.length}</div>
                        ...
                        <div className="stat-card">
                          ...
                          <div className="stat-label">Precisão IA</div>
                        </div>
                      </div>
      ...
      {/* 📱 NAVEGAÇÃO INFERIOR MOBILE (NOVO DESIGN PREMIUM 5 BOTÕES) */}
      <div className="bottom-nav" style={{ display: isMobile ? 'flex' : 'none' }}>
        
        <button 
            className={`nav-item ${viewMode === 'jogos' && menuAtivo === 'Todos os Jogos' && !showMobileLigas && filterCentro !== 'Ao Vivo' ? 'active' : ''}`} 
        ...
        <button 
            className={`nav-item ${viewMode === 'blog' && !showMobileLigas ? 'active' : ''}`} 
            onClick={() => {setViewMode('blog'); setShowMobileLigas(false); setJogoSelecionado(null);}}
            style={{background: 'none', border: 'none'}}
        >
          <span className="nav-icon">📊</span>
          <span>Análises</span>
