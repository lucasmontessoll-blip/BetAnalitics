                  ...
                  <div className="px-4 animate-fade-in">
                      ...
                      <div className="bg-[#0f172a] p-5 rounded-3xl mb-6 shadow-lg border border-white/5">
                          ...
                          <div className="flex justify-between items-center bg-[#111827] p-3 rounded-xl border border-white/5">
                              <div><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest block">Lucro Limpo</span><span className="text-green-400 font-black text-sm">R$ {lucroAcumulado().toFixed(2)}</span></div>
