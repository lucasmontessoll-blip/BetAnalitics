...
<button onClick={() => setAiOpen(true)} className="fixed right-4 bottom-24 z-[999] w-16 h-16 rounded-full bg-blue-500/25 border border-blue-300/50 shadow-[0_0_28px_rgba(59,130,246,0.55)] backdrop-blur-md flex flex-col items-center justify-center opacity-85 active:scale-95" aria-label="Abrir Assistente IA" title="IA">
  <span className="absolute inset-0 rounded-full bg-blue-400/20 blur-md"></span>
  <span className="relative text-2xl leading-none drop-shadow">{'\u{1F916}'}</span>
  <span className="relative text-[9px] font-black text-white/80 -mt-0.5 tracking-wide">IA</span>
</button>
<AnimatePresence>
