...
const file = "src/components/JogosPorPaisContinente.jsx";
...
fs.writeFileSync(file, codigo, "utf8");

console.log("JogosPorPaisContinente restaurado com emojis e acentos seguros.");
